...
public class Test2
{
	...
	{
		int iDices, iRound = 0, iScore = 0, iWin = 0, iLose = 0, iChoice;
		char cResult;
		...
		do
		{
			...
			do
			{
			aryGuess[iRound] = (JOptionPane
					.showInputDialog(String.format("Round %d: What's your guess? (L for Low and H for High)", iRound)))
							.charAt(0);
		...
		} while (iChoice == JOptionPane.YES_OPTION); //keep playing if the user chooses YES

		JOptionPane.showMessageDialog(null,
				String.format("You've played %d times.\nYou've won %d times and lost %d times.\nYour final score is %d.",
